...
class LogoCreator:
    ...
    def manual_workflow(self):
        workflow = [
            {
                "action_type": "chat",
                "action": "Gather business information (name, industry, target audience)",
                "tool_use": []
            },
            {
                "action_type": "chat",
                "action": "Identify brand personality and values",
                "tool_use": []
            },
            {
                "action_type": "chat",
                "action": "Generate logo concepts and variations",
                "tool_use": []
            }
        ]
        return workflow
