...
class MusicComposer:
    ...
    def manual_workflow(self):
        workflow = [
            {
                "action_type": "chat",
                "action": "Gather user information about desired music genre, mood, and tempo.",
                "tool_use": []
            },
            {
                "action_type": "chat",
                "action": "Convert musical elements into audio.",
                "tool_use": []
            },
            {
                "action_type": "chat",
                "action": "Summarize the generated music and provide suggestions for improvement.",
                "tool_use": []
            }
        ]
        return workflow
